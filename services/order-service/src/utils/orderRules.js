...
export const ALLOWED_TRANSITIONS = {
  ...
  // Restored now that order.cancelled outbox event + inventory release
  // (release_stock_for_order / order.stock_release_requested) are built.
  Processing: { Confirmed: ["Admin"], Cancelled: ["Admin", "Customer"] },

  Confirmed: { Shipped: ["Admin"] , Cancelled: ["Admin"] }, // no Cancelled — refunds don't exist yet
